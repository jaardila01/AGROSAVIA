...
void loop()
{
  ...
  if (Serial.available() >= 0)
  {
    ...
    if (y == '9')
    { 
      //Serial2.println("[J0000001A00000000000F4240]");                                                    
      Serial2.println("[J0000001A00000000000F4240000310C400004E20000001060000010C00000140000B7D300009607200077A83FD6C48BCFDCA7230FFE8B1B7FCB4951CFF30A220FEBB79760000026200000297000000140001C2000000000000038E930003AB85]");
      Serial.println("COMANDO J ENVIADO BAUD RATE 115200");
